...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # or wherever your templates are located
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'jelaicabtabanag@gmail.com'
EMAIL_HOST_PASSWORD = 'inll jtmn gwxq zwap'  # This is the app password you just generated
